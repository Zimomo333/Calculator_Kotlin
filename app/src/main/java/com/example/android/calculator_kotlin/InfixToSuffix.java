        ...
        for (String anArr : arr) {
            ...
            switch (anArr) {
                ...
                case "/":
                    ...
                    break;
                case "%":
                    BigDecimal[] e = new BigDecimal(list.remove(size - 2)).divideAndRemainder(new BigDecimal(list.remove(size - 2)));
                    list.add(e[1].stripTrailingZeros().toString());
                    break;
                case "^":
                    BigDecimal f = new BigDecimal(list.remove(size - 2)).pow(new BigDecimal(list.remove(size - 2)).intValue());
                    list.add(f.stripTrailingZeros().toString());
                    break;
                default:
                    list.add(anArr);
                    break;
